        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <div class="col-xs-9">
                            <strong>SMTP Invio Mail</strong>
                        </div>
                    </div>

                    <div class="form-group">
                        <label class="control-label col-xs-3">Server SMTP</label>
                        <div class="col-xs-9">
                            <input type="text" class="form-control" name="configs[mailbox_configs_server_smtp]" value="<?php echo $data['edit']? $data['address']['mailbox_configs_server_smtp']: null; ?>" />
                        </div>
                    </div>

                    <div class="form-group">
                        <label class="control-label col-xs-3">User SMTP</label>
                        <div class="col-xs-9">
                            <input type="text" class="form-control" name="configs[mailbox_configs_user_smtp]" value="<?php echo $data['edit']? $data['address']['mailbox_configs_user_smtp']: null; ?>" />
                        </div>
                    </div>

                    <div class="form-group">
                        <label class="control-label col-xs-3">Password SMTP</label>
                        <div class="col-xs-9">
                            <input type="password" class="form-control" name="configs[mailbox_configs_password_smtp]" placeholder="<?php echo $data['edit']? 'Lascia vuoto per mantenere': ''; ?>" />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label class="control-label col-xs-3">Port</label>
                        <div class="col-xs-9">
                            <input type="text" class="form-control" name="configs[mailbox_configs_port_smtp]" value="<?php echo $data['edit']? $data['address']['mailbox_configs_port_smtp']: null; ?>" placeholder="25" />
                            <span class="help-block">
                                Porte standard SMTP: <strong>25</strong>,
                                <strong>465</strong> in SSL/TLS
                            </span>
                        </div>
                    </div>

                    <div class="form-group">
                        <label class="control-label col-xs-3">Invio mail</label>
                        <div class="col-xs-9">
                            <input type="radio" class="form-control" name="configs[mailbox_configs_default_smtp]" value="mailbox_configs_default_smtp" <?php echo $data['edit']? ($data['address']['mailbox_configs_default_smtp'] == "t") ? "checked" : null : null; ?>  /> Si
                            <input type="radio" class="form-control" name="configs[mailbox_configs_default_smtp]" value="" <?php echo $data['edit']? ($data['address']['mailbox_configs_default_smtp'] == "f") ? "checked" : null : null; ?>  /> No
                            <span class="help-block">
                                Questa impostazione riduce drasticamente le possibilità che le e-mail inviate dal gestionale possano finire in spam.
                            </span>
                        </div>
                    </div>
